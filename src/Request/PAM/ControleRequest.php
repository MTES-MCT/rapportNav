...
class ControleRequest {
     ...
     * @return mixed
     */
    public function getNbPvEquipementSecurite() {
        return $this->nb_pv_equipement_securite;
    }

    /**
     * @param mixed $nb_pv_equipement_securite
     */
    public function setNbPvEquipementSecurite($nb_pv_equipement_securite): void {
     ...
     */
    public function getType(): ?ControleTypeRequest {
        return $this->type;
    }

    /**
     * @param ControleTypeRequest|null $type
     */
    public function setType(?ControleTypeRequest $type): void {
        $this->type = $type;
    }
