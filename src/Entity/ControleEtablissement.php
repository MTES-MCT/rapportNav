...
class ControleEtablissement implements JsonSerializable {
    ...
    /**
     * @ORM\ManyToOne(targetEntity="ActiviteCommerce", inversedBy="etablissements")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Etablissement", cascade={"persist", "remove"})
     * @ORM\JoinColumn(nullable=false)
     * @Assert\Valid
     */
    ...
    public function jsonSerialize() {
        $data = [
            ...
            'pv' => $this->getPv(),
            'showDetail' => 'Autre' === $this->getEtablissement()->getType()->getNom(),
