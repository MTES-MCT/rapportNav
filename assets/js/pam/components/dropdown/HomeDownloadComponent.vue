<template>
  <div >
    <button class="fr-btn fr-btn--secondary" @click="hidden = !hidden" ref="downloadDropdown" >
...
export default {
  ...
  methods: {
    ...
    exportRapport() {
      window.location.href = sanitizeUrl('/api/pam/export/rapport/' + this.rapport.id + (this.rapport.type === 'brouillon' ? '?draft' : ''));
    }
  },
  data() {
    return {
